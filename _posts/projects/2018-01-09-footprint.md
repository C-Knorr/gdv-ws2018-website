...
2.[These](#These)
3.[Daten](#Daten)
    3.1.[Datenquelle](#Datenquelle)
    3.2.[Datenerhebung](#Datenerhebung)
    3.3.[Datenaufbereitung](#Datenaufbereitung)
4.[Prozess](#Prozess)
5.[Prototypen](#Prototypen)
    5.1.[Visualisierung mit D3.js](#Visualisierung)
        5.1.1.[Treemap](#Treemap)
        5.1.2.[Säulendiagramm](#Säulendiagramm)
        5.1.3.[Linendiagramm](#Linendiagramm)
    5.2.[Visualisierung mit amChart](#Visualisierung)
        5.2.1.[Library](#Library)
        5.2.2.[container](#container)
        5.2.3.[Treemap](#Treemap)
            5.2.3.1.[Biokapazität Treemap](#Biocapacity)
            5.2.3.2.[Ökologischer Fußabdruck](#Ökologischer Fußabdruck)
            5.2.3.3.[Treemap Text](#Treemap Text)
            5.2.3.4.[Treemap hover methoden](#Treemap hover methoden)
        5.3.4.[XYChart](#XYChart)
            5.3.4.1.[series](#series)
            5.3.4.2.[Legende](#Legende)
        5.4.5.[Events](#Events)
        5.5.6.[Interaction](#Interaction)
...
Grundlagen der Informationsvisualisierung (GDV), Wintersemester 2018/2019 bei Herrn [Prof. Dr. Till Nagel](https://services.informatik.hs-mannheim.de/~nagel/), Hochschule Mannheim
