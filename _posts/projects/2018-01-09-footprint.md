...
5.[Prototypen](#Prototypen)
    5.1.[Visualisierung mit D3.js](#Visualisierung)
        5.1.[Treemap](#Treemap)
        5.2.[Säulendiagramm](#Säulendiagramm)
        5.3.[Linendiagramm](#Linendiagramm)
    5.2.[Visualisierung mit amChart](#Visualisierung)
        5.1.[Library](#Library)
        5.2.[container](#container)
        5.3.[Treemap](#Treemap)
            5.3.1.[Biokapazität Treemap](#Biocapacity)
            5.3.2.[Ökologischer Fußabdruck](#Ökologischer Fußabdruck)
            5.3.3.[Treemap Text](#Treemap Text)
            5.3.4.[Treemap hover methoden](#Treemap hover methoden)
        5.3.4.[XYChart](#XYChart)
            5.4.1.[series](#series)
            5.4.2.[Legende](#Legende)
        5.4.5.[Events](#Events)
