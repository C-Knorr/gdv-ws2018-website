...
Die geplanten "Flags" wurden aufgrund von gestalterischen Gründen zu einem Textfeld. Dieses zeigt zu jedem ausgewählten
Jahr einen kurzen Text an der ein Ereignis dieses Jahres im Zusammenhang mit dem SDG-3 beschreibt.
...
### Interaktive Karten
Beide Welt-Choroplethenkarten zeigen genauere Infos über ein Land wenn der Benutzer die Maus über ein Land bewegt.
<video autoplay loop muted playsinline style="width: 100%">
    <source src="{{ site.urlimg }}health/Datamaps Tooltip.mp4">
</video>
Darüber hinaus kann der Benutzer auswählen, welche Datensatz in einer Karte visualisiert wird.
<video autoplay loop muted playsinline style="width: 100%">
    <source src="{{ site.urlimg }}health/Data Type.mp4">
</video>

### Timeline
Über eine Schieberegler kann der Benutzer das Jahr auswählen, dieses von allen Visualisierungen angezeigt wird.
...
##### Easter Egg:
- Drücke die Taste `L` um zufällig ein Jahr weiter zu gehen oder die ausgewählten Datensätze zu wechseln.
- Drücke die Taste `K` um den Zufälligen Präsentationsmodus zu aktivieren.
- Drücke die Taste `S` um den Zufälligen Präsentationsmodus automatisch zu aktivieren, wenn du die Maus für 60 Sekunden
nicht bewegt hast und zu deaktivieren sobald du die Maus wieder bewegst.
