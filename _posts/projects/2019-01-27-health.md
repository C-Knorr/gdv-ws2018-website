...
Unter der Chloroplethenkarte sollte ein Stacked Area Chart platziert sein, jedoch haben wir uns dagegen entschieden und
haben uns stattdessen für einen Scatterplot entschieden. Diese lies sich am Ende besser implementieren und hatte eine
bessere Übersicht, da man durch die Auswahl der einzelnen Länder in der Chloroplethenkarte automatisch das Land im
Scatterplot markiert hat. Im Stacked Area Chart wäre dies nicht möglich gewesen und im Scatterplot ist die Abhängigkeit
von den Ländern der Erde zu der Zeit trotz dessen vorhanden. Zu den Chloroplethenkarten und dem Scatterplot wurde ein
Zeitstrahl entwickelt, wo man zwischen 2000 und 2015 navigieren kann. Es ist außerdem möglich, diese automatisch
abzuspielen.


![Sketch](/health/sketch.png)


## Implementierung und Prototyp <a name="prototyp"></a>

![Prototyp](/health/prototyp_auswahl.png)
...
Die beiden Chloroplethenkarten zeigen mithilfe eines Filters zwei unserer drei Datensätze. Anhand dem Datensatz 
"Todesfälle durch Tuberkulose" lässt sich unserer erste Hypothese bestätigen. Der Entwicklungsgrad und der Wohlstand 
der einzelnen Regionen zeigt hierbei auch einen starken Einfluss auf die Sterberate von Tuberkulose, vor allem in Afrika. 

Auch wird unsere nächste Hypothese bestätigt, die man anhand den beiden verbleibenden Datensätzen sich auf den 
Chloroplethenkarten anzeigen lassen kann. Im Verlauf der einzelnen Jahre kann man einen großen Anstieg an 
Gesundheitsausgaben in verschiedenen Regionen erkennen, vor allem in Afrika. Diese lassen sich durch Maßnahmen gegen 
Tuberkulose, wie z.B. Spendenaktionen oder neue Medikamente erklären.

Mithilfe unseres Projekts haben wir gezeigt, wo die Krankheit Tuberkulose am häufigsten vorkommt und wie es sich im 
Zeitraum von 2000 bis 2015 entwickelt hat.

## Ausblick <a name="ausblick"></a>

Aufgrund des zeitlichen Rahmens konnten einige Features nicht umgesetzt werden, wie die Aufbereitung von 
Visualisierungen für explizite Maßnahmen oder Spendenaktionen in den jeweiligen Ländern. Es wäre durch die 
Aufbereitungen der möglichen Visualisierungen von Maßnahmen denkbar gewesen, zwischen mehr als drei Chloroplethenkarten 
zu wechseln. Jedoch hat das dann doch mehr Datenquellen vorausgesetzt, was wir aufgrund des Zeitmangels nicht 
recherchieren konnten.

Dieses Ergebnis stellt die Situation von Tuberkulose bis zum Jahr 2015 dar. Anhand dieser Daten könnte man gezielt für die 
noch zu stark betroffenen Länder Maßnahmen bzw. Spendenaktionen organisieren.