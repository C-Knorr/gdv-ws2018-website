...
![image]({{ site.urlimg }}gallery/UNDataSchritt1.png)*Abbildung:Filteroperationen*
...
![image]({{ site.urlimg }}gallery/UNDataSchritt2.png)*Abbildung:ETL-Pipeline Overview*
...
![image]({{ site.urlimg }}gallery/Webscraping1.png)*Abbildung:table Scraping*
...
![image]({{ site.urlimg }}gallery/Webscrapping2.png)*Abbildung:ETL-Tool Pentaho*
...
![image]({{ site.urlimg }}gallery/Webscrapping3.png)*Abbildung:Substitution*
...
![image]({{ site.urlimg }}gallery/Ethiopia.png)*Abbildung: Äthiopien: Bildungsausgaben und Crime index*

Brasilien:
- Hier stiegen die Bildungsausgaben kontinuierlich an, jedoch stieg zugleich der
Crime Index an.

![image]({{ site.urlimg }}gallery/Brazil.png)*Abbildung: Brasilien: Bildungsausgaben und Crime index*


Afghanistan
- Trotz unterschiedlichen Bildungsausgaben sinkt Crime Index kontinuierlich.

![image]({{ site.urlimg }}gallery/Afghanistan.png)*Abbildung: Afghanistan: Bildungsausgaben und Crime index*
